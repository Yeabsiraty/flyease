  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <form
        ...
        className="mt-8 grid gap-5 rounded-2xl border border-border bg-card/60 p-6 sm:p-8"
      >
        <Field
          label="Name and surname (will be used for the nameplate)"
          required
        >
          <input
            required
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <NumberField
            ...
            value={form.children12}
            onChange={(v) => set("children12", v)}
          />
          <NumberField
            label="Children under 2"
            value={form.children2}
            onChange={(v) => set("children2", v)}
          />
          <NumberField
            label="Checked-in baggage"
            value={form.baggage}
            onChange={(v) => set("baggage", v)}
          />
        </div>
    ...
    <Field label={label}>
      <div className="flex items-center rounded-lg border border-border bg-input">
        <button
          ...
          className="h-12 w-12 text-gold transition hover:bg-secondary"
        >
          −
        </button>
